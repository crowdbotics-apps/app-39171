"""
Django settings for app_39171 project.
...
WSGI_APPLICATION = 'app_39171.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app_39171 API",
    "DESCRIPTION": "API documentation for app_39171 App",
    "VERSION": "v1",
}
